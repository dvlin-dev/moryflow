...
import { ArrowRightIcon } from '@moryflow/ui/icons/arrow-right-icon';
import { ArrowUpIcon } from '@moryflow/ui/icons/arrow-up-icon';
import { ArrowDownIcon } from '@moryflow/ui/icons/arrow-down-icon';
...
function tableMoveRowColumn({
  ...
  try {
    ...
    if (editor.state.selection instanceof CellSelection) {
      ...
      const selectionState = selectCellsByCoords(editor, table.pos, sourceCoords, {
        mode: 'state',
      });
