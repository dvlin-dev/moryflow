const en = {
  ...
  signInForMemberModels: 'Sign in to view member models',
  tasksSheetTitle: 'Tasks',
  ...
  loadingTaskDetails: 'Loading details…',
  selectTaskToViewDetails: 'Select a task to view details.',
  ...
  noWorkspaceFiles: 'No files in workspace',
  moreFilesHint: '{{count}} more files, use search to find them',
  taskStatusTodo: 'Todo',
