...
const ar = {
  ...
  closeBehavior: 'عند إغلاق النافذة',
  closeBehaviorDescription: 'اختر ما الذي يحدث عند الضغط على زر إغلاق النافذة.',
  closeBehaviorHide: 'إخفاء إلى شريط القوائم',
  closeBehaviorHideDescription: 'الاستمرار في تشغيل Moryflow في شريط القوائم.',
  closeBehaviorQuit: 'إنهاء التطبيق',
  closeBehaviorQuitDescription: 'إنهاء Moryflow بالكامل.',
  closeBehaviorUpdateFailed: 'فشل تحديث سلوك الإغلاق',
  launchAtLogin: 'التشغيل عند تسجيل الدخول',
  launchAtLoginDescription: 'تشغيل Moryflow تلقائيًا عند تسجيل الدخول.',
  launchAtLoginUpdateFailed: 'فشل تحديث إعداد التشغيل عند تسجيل الدخول',
  runtimeSettingsLoadFailed: 'فشل تحميل إعدادات وقت التشغيل للتطبيق',
  updateChannel: 'قناة التحديث',
  updateChannelDescription: 'اختر ما إذا كان هذا الجهاز يتبع الإصدارات المستقرة أو معاينات البيتا.',
  updateChannelStable: 'مستقرة',
  updateChannelStableDescription: 'مناسبة للاستخدام اليومي مع الإصدارات الرسمية فقط.',
  updateChannelBeta: 'بيتا',
  updateChannelBetaDescription: 'احصل على الإصدارات التجريبية مبكرًا مع احتمال بعض عدم الاستقرار.',
  updateChannelUpdateFailed: 'فشل تحديث قناة الإصدار',
  automaticUpdateChecks: 'التحقق التلقائي من التحديثات',
  automaticUpdateChecksDescription: 'التحقق من الإصدارات الجديدة في الخلفية بعد التشغيل.',
  autoCheckUpdateFailed: 'فشل تحديث إعداد التحقق التلقائي من التحديثات',
  manualUpdatePolicyDescription:
    'يتطلب التنزيل والتثبيت دائمًا تأكيدك. لن يقوم Moryflow بتثبيت تحديث قسريًا.',
  ...
  cloudSyncConflictCopyReady: 'نسخة التعارض جاهزة',
  ...
  cloudSyncTryAgain: 'حاول مرة أخرى',
  cloudSyncOpenConflictCopy: 'افتح نسخة التعارض',
  cloudSyncOpenFirstConflictCopy: 'افتح أول نسخة تعارض',
