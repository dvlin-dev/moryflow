...
const ar = {
  ...
  resetSettingsDescription:
    'مسح جميع بيانات التكوين والعودة إلى الحالة الأولية. لن تتأثر ملفات مساحة العمل. يتطلب إعادة التشغيل.',
  resetSettingsConfirm:
    'هل أنت متأكد من إعادة تعيين الإعدادات؟\n\nسيتم حذف جميع بيانات التكوين (لن تتأثر ملفات مساحة العمل). ستصبح التغييرات فعالة بعد إعادة التشغيل.',
