...
import { getCurrentSpan, setTraceProcessors, setTracingDisabled, withTrace } from '../src/tracing';
...
describe('with*Span helpers', () => {
  ...
  it('records errors and restores the previous span when the callback throws', async () => {
    ...
    const functionSpan = processor.spansEnded.find((span) => span.spanData.type === 'function');
