...
import { Model, ModelProvider, ModelRequest, ModelResponse } from '../src/model';
...
import type { Editor, ApplyPatchOperation, ApplyPatchResult } from '../src/editor';
...
export class FakeEditor implements Editor {
  ...
  private async handle(operation: ApplyPatchOperation): Promise<ApplyPatchResult | void> {
