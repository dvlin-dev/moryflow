...
describe('errors', () => {
  test('should be initialized', () => {
    ...
    expect(() => {
      throw new InputGuardrailTripwireTriggered('Test error', {} as any, {} as any);
    }).toThrow('Test error');
    expect(() => {
      throw new OutputGuardrailTripwireTriggered('Test error', {} as any, {} as any);
    }).toThrow('Test error');
    const cause = new Error('cause');
    const guardrailError = new GuardrailExecutionError('Test error', cause, {} as any);
