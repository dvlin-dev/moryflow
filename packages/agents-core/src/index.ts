/**
 * [PROVIDES]: Agent, run, Tool, Model, MCP, Tracing - Agent 框架核心 API
 * [DEPENDS]: zod, openai-protocol - 类型验证与协议解析
 * [POS]: agents 框架核心层，被 agents-openai、agents 顶层包依赖
 *
...
export { RuntimeEventEmitter } from '@moryflow/agents-core/_shims';
export {
  Agent,
  AgentConfiguration,
