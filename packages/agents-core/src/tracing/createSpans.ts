 ...
 */
export const withResponseSpan = _withSpanFactory<ResponseSpanData, typeof createResponseSpan>(
  createResponseSpan
);
 ...
 */
export const withAgentSpan = _withSpanFactory<AgentSpanData, typeof createAgentSpan>(
  createAgentSpan
);
 ...
 */
export const withFunctionSpan = _withSpanFactory<FunctionSpanData, typeof createFunctionSpan>(
  createFunctionSpan
);
 ...
 */
export const withHandoffSpan = _withSpanFactory<HandoffSpanData, typeof createHandoffSpan>(
  createHandoffSpan
);
...
export const withGenerationSpan = _withSpanFactory<GenerationSpanData, typeof createGenerationSpan>(
...
export const withCustomSpan = _withSpanFactory<CustomSpanData, typeof createCustomSpan>(
  createCustomSpan
);
...
export const withGuardrailSpan = _withSpanFactory<GuardrailSpanData, typeof createGuardrailSpan>(
  createGuardrailSpan
);
...
export const withSpeechSpan = _withSpanFactory<SpeechSpanData, typeof createSpeechSpan>(
  createSpeechSpan
);
