 ...
 */
export type OutputGuardrailFunction<TOutput extends AgentOutputType = TextOutput> = (
 ...
 */
export function defineOutputGuardrail<TOutput extends AgentOutputType = TextOutput>({
  name,
  execute,
