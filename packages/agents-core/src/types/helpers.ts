...
export type ResolveParsedToolParameters<TInputType extends ToolInputParameters> =
...
export type JsonObjectSchema<Properties extends Record<string, JsonSchemaDefinitionEntry>> =
  | JsonObjectSchemaStrict<Properties>
  | JsonObjectSchemaNonStrict<Properties>;
...
export type HandoffsOutput<H> =
  H extends Array<infer U> ? ExtractAgentOutput<U> | ExtractHandoffOutput<U> : never;
