...
> = {
   ...
   * @param output - The output of the agent
   */
  agent_end: [context: RunContext<TContext>, agent: Agent<TContext, TOutput>, output: string];
  /**
   * @param context - The context of the run
...
> extends EventEmitterDelegate<RunHookEvents<TContext, TOutput>> {
  protected eventEmitter = new RuntimeEventEmitter<RunHookEvents<TContext, TOutput>>();
}
