  ...
  constructor(input?: UsageInput) {
    if (typeof input === 'undefined') {
      ...
      if (Array.isArray(inputTokensDetails)) {
        this.inputTokensDetails = inputTokensDetails as Array<Record<string, number>>;
      } else {
        this.inputTokensDetails = inputTokensDetails
          ? [inputTokensDetails as Record<string, number>]
          : [];
      ...
      if (Array.isArray(outputTokensDetails)) {
        this.outputTokensDetails = outputTokensDetails as Array<Record<string, number>>;
      } else {
        this.outputTokensDetails = outputTokensDetails
          ? [outputTokensDetails as Record<string, number>]
          : [];
      ...
      this.requestUsageEntries =
        normalizedRequestUsageEntries && normalizedRequestUsageEntries.length > 0
