...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'bg-card text-card-foreground flex flex-col rounded-xl border border-border-muted shadow-sm transition-all duration-fast hover:shadow-md hover:border-border',
        className
      )}
      {...props}
    />
