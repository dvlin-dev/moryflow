...
export const InlineCitationText = ({ className, ...props }: InlineCitationTextProps) => (
  <span
    className={cn('transition-colors duration-fast group-hover:bg-accent', className)}
    {...props}
  />
);
...
export const InlineCitationCarouselHeader = ({
  ...
  <div
    className={cn(
      'flex items-center justify-between gap-2 rounded-t-lg bg-secondary p-2',
      className
    )}
    {...props}
  />
...
export const InlineCitationQuote = ({
  ...
  <blockquote
    className={cn(
      'border-border-muted border-l-2 pl-3 text-muted-foreground text-sm italic',
      className
    )}
    {...props}
  >
