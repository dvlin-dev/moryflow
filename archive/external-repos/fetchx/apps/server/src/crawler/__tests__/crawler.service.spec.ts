  ...
  describe('startCrawl', () => {
    ...
    describe('options handling', () => {
      it('should use default values when options not provided', async () => {
        ...
        await service.startCrawl('user_1', { url: 'https://example.com', maxDepth: 3, limit: 100, allowExternalLinks: false });
  ...
  describe('getStatus', () => {
    ...
    it('should include page data for completed job', async () => {
      ...
      mockPrisma.crawlPage.findMany.mockResolvedValue([
        ...
        { url: 'https://example.com/about', depth: 1, result: { markdown: 'About' } },
      ]);
