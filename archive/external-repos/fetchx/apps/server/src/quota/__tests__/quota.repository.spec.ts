...
describe('QuotaRepository', () => {
  ...
  describe('deductMonthlyInTransaction', () => {
    it('should execute transaction with correct operations', async () => {
      ...
      const result = await repository.deductMonthlyInTransaction('user_1', 1, 'ss_1');
  ...
  describe('deductPurchasedInTransaction', () => {
    it('should execute transaction correctly', async () => {
      ...
      const result = await repository.deductPurchasedInTransaction('user_1', 1, 'ss_1');
  ...
  describe('refundInTransaction', () => {
    it('should refund to monthly quota', async () => {
      ...
      const result = await repository.refundInTransaction('user_1', 1, 'MONTHLY', 'ss_1');
    ...
    it('should refund to purchased quota', async () => {
      ...
      const result = await repository.refundInTransaction('user_1', 1, 'PURCHASED', 'ss_1');
  ...
  describe('addPurchasedInTransaction', () => {
    it('should add purchased quota', async () => {
      const transactionResult = {
        ...
        transaction: { id: 'tx_purchase', balanceBefore: 50, balanceAfter: 150 },
      };
      ...
      const result = await repository.addPurchasedInTransaction('user_1', 100, 'order_123');
