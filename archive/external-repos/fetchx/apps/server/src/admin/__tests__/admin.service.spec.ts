...
describe('AdminService', () => {
  ...
  describe('getUsers', () => {
    it('should return paginated users', async () => {
      ...
      const result = await service.getUsers({ page: 1, limit: 10, isAdmin: undefined });
    ...
    it('should apply search filter', async () => {
      ...
      await service.getUsers({ page: 1, limit: 10, search: 'test', isAdmin: undefined });
  ...
  describe('updateSubscription', () => {
    it('should update subscription', async () => {
      ...
      const result = await service.updateSubscription('sub_1', { tier: 'TEAM' });
