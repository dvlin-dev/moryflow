...
| 模块 | 路径 |
|------|------|
| 模块定义 | `apps/server/src/speech/speech.module.ts` |
| 控制器 | `apps/server/src/speech/speech.controller.ts` |
| 服务 | `apps/server/src/speech/speech.service.ts` |
| Groq 客户端 | `apps/server/src/speech/groq.client.ts` |
| 文本优化服务 | `apps/server/src/speech/text-refiner.service.ts` |
