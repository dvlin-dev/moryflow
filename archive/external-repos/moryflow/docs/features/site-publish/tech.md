...
| 模块 | 路径 |
|------|------|
| 站点构建 | `apps/pc/src/main/site-publish/site-builder.ts` |
| MD 渲染 | `apps/pc/src/main/site-publish/markdown-renderer.ts` |
| IPC 处理 | `apps/pc/src/main/site-publish/index.ts` |
| Server API | `apps/server/src/site/` |
| Worker | `apps/publish-worker/` |
| UI 组件 | `apps/pc/src/renderer/components/share/` |
