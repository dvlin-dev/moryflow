...
| 模块 | 路径 |
|------|------|
| 站点控制器 | `apps/server/src/site/site.controller.ts` |
| IPC 类型 | `apps/pc/src/shared/ipc/site-publish.ts` |
| 主进程逻辑 | `apps/pc/src/main/site-publish/index.ts` |
| Sites 页面 | `apps/pc/src/renderer/workspace/components/sites/index.tsx` |
| 站点详情组件 | `apps/pc/src/renderer/workspace/components/sites/site-detail.tsx` |
