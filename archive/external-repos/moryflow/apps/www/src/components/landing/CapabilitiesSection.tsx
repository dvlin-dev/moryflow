...
const capabilities = [
  {
    ...
    examples: ['Tracks your learning progress', 'Knows your work habits', 'Remembers your travel style'],
  ...
  },
  {
    ...
    examples: ['Searches latest exam formats', 'Finds creative event ideas', 'Looks up travel routes'],
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg md:text-xl text-mory-text-secondary max-w-3xl mx-auto leading-relaxed">
            ...
            <br />
            <span className="font-medium text-mory-text-primary">The more you use it, the better it knows you.</span>
          </p>
        </div>
                ...
                >
                  ...
                  <p
                    className={`text-base mb-6 leading-relaxed ${
                      capability.isFuture ? 'text-mory-text-tertiary italic' : 'text-mory-text-secondary'
                    }`}
                  >
                    {capability.desc}
                  </p>
                  ...
                  <div className="mt-auto">
                    <p
                      className={`text-xs uppercase tracking-wider mb-3 font-medium ${
                        capability.isFuture ? 'text-mory-text-tertiary/50' : 'text-mory-text-tertiary'
                      }`}
                    >
                      ...
                      {capability.examples.map((example, i) => (
                        <li
                          ...
                          className={`flex items-start gap-2 text-sm ${
                            capability.isFuture ? 'text-mory-text-tertiary' : 'text-mory-text-secondary'
                          }`}
                        >
                          <span
                            className={`mt-0.5 ${
