    ...
    <main className="pt-24 pb-20">
      <article className="px-4 sm:px-6 py-16">
        <div className="container mx-auto max-w-3xl prose prose-gray prose-headings:font-serif">
          ...
          <p>
            By downloading or using Moryflow, you agree to be bound by these Terms of Service.
          ...
          <h3>License</h3>
          <p>
            We grant you a non-exclusive, non-transferable license to use Moryflow for personal
            or commercial purposes, subject to these terms.
          </p>
          ...
          <h2>AI Features</h2>
          <p>
            Moryflow includes AI-powered features. While we strive for accuracy:
          </p>
          <ul>
          ...
          <p>
            To the maximum extent permitted by law, Moryflow shall not be liable for any
