...
import { Brain, Globe, PenTool, Shield, Zap, Sparkles } from 'lucide-react'

export const Route = createFileRoute('/features')({
  head: () => ({
    meta: generateMeta({
      title: 'Features',
      description: 'Explore Moryflow\'s powerful features - memory, web search, content creation, and more.',
      path: '/features',
    }),
...
const features = [
  {
    ...
    description: 'Mory remembers your notes, habits, and preferences. The more you use it, the better it understands you.',
    color: 'from-orange-500 to-amber-500',
  },
  {
    icon: Globe,
    title: 'Web Search',
    description: 'When needed, Mory searches the web for the latest information - exam tips, creative ideas, travel guides.',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    icon: PenTool,
    title: 'Content Creation',
    description: 'Not just answering questions - Mory generates content. Study plans, proposals, work summaries.',
    color: 'from-purple-500 to-pink-500',
  },
  {
    icon: Shield,
    title: 'Local-first Privacy',
    description: 'Your data stays on your device by default. No cloud uploads unless you choose to sync.',
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-24">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-mory-text-secondary max-w-2xl mx-auto">
            Mory combines multiple capabilities to help you accomplish any task.
