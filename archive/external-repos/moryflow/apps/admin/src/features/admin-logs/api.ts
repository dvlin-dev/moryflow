...
export const activityLogsApi = {
  ...
  query: (params: ActivityLogQueryParams) => {
    ...
    return adminApi.get<ActivityLogListResponse>(
  ...
  /** 获取存储统计 */
  getStorageStats: () =>
    adminApi.get<ActivityLogStorageStats>('/activity-logs/stats'),
  ...
  exportLogs: async (
    ...
    const blob = await apiClient.postBlob('/api/admin/activity-logs/export', params)
