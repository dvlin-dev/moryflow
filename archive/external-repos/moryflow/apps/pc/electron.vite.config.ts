  ...
  renderer: {
    ...
    resolve: {
      alias: [
        ...
        { find: /^@moryflow\/ui\/(.*)$/, replacement: resolve(__dirname, '../../packages/ui/src/$1') },
        // styles 目录在包根目录，需单独处理
        { find: /^@moryflow\/tiptap\/styles\/(.*)$/, replacement: resolve(__dirname, '../../packages/tiptap/styles/$1') },
        { find: /^@moryflow\/tiptap\/(.*)$/, replacement: resolve(__dirname, '../../packages/tiptap/src/$1') },
        { find: '@moryflow/ui', replacement: resolve(__dirname, '../../packages/ui/src') },
        { find: '@moryflow/tiptap', replacement: resolve(__dirname, '../../packages/tiptap/src') }
      ],
