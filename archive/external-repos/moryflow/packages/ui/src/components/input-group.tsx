...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-border-muted dark:bg-input/30 relative flex w-full items-center rounded-lg border shadow-xs transition-all duration-fast outline-hidden",
