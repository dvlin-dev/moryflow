...
// Type helpers for React ref access across versions
type ReactElementWithRef = React.ReactElement & { ref?: React.Ref<unknown> }
type ReactElementWithPropsRef = React.ReactElement & { props: { ref?: React.Ref<unknown> } }

function getChildRef(children: React.ReactElement): React.Ref<unknown> | undefined {
  if (parseInt(version, 10) >= 19) {
    return (children as ReactElementWithPropsRef).props.ref
  }
  return (children as ReactElementWithRef).ref
}

export const TooltipTrigger = forwardRef<HTMLElement, TooltipTriggerProps>(
  function TooltipTrigger({ children, asChild = false, ...props }, propRef) {
    const context = useTooltipContext()
    const childrenRef = isValidElement(children) ? getChildRef(children) : undefined
