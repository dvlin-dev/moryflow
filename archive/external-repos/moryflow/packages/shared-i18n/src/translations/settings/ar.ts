...
const ar = {
  ...
  deleteAccountWarning: 'بعد حذف حسابك، سيتم مسح جميع بياناتك نهائياً. لا يمكن التراجع عن هذا الإجراء.',
  ...
  resetSettingsDescription: 'مسح جميع بيانات التكوين والعودة إلى الحالة الأولية. لن تتأثر ملفات Vault. يتطلب إعادة التشغيل.',
  resetSettingsConfirm: 'هل أنت متأكد من إعادة تعيين الإعدادات؟\n\nسيتم حذف جميع بيانات التكوين (لن تتأثر ملفات Vault). ستصبح التغييرات فعالة بعد إعادة التشغيل.',
  ...
  defaultModelFormatHint: 'التنسيق: معرف_المزود/معرف_النموذج. إذا تُرك فارغًا، سيتم استخدام النموذج الافتراضي للمزود الأول المفعّل.',
  defaultModelConfigDescription: 'يرجى تكوين المزودين والنماذج في صفحة "مزودو الذكاء الاصطناعي"، ثم قم بتعيين النموذج الافتراضي العام هنا.',
