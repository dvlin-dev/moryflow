...
[PROTOCOL]: 本文件变更时，需同步更新 docs/design/index.md、docs/CLAUDE.md；若影响全局约束（域名/路由/模型），需同步更新根 CLAUDE.md。
-->
...
> 反代与部署 runbook：
>
> - megaboxpro（1panel）：`docs/design/anyhunt/runbooks/megaboxpro-1panel-reverse-proxy.md`
> - Anyhunt Dokploy：`docs/design/anyhunt/runbooks/anyhunt-dokploy.md`
