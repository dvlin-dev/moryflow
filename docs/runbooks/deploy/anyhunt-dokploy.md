...
| anyhunt-console | `apps/anyhunt/console/Dockerfile`   | 80   | `console.anyhunt.app`         | Build Args：`VITE_API_URL`<br>`VITE_AUTH_URL`                                                                                                                                                      | `apps/anyhunt/console/**`<br>`packages/types/**`<br>`packages/auth-client/**`<br>`packages/ui/**`<br>`packages/embed/**`<br>`packages/embed-react/**`<br>`tooling/typescript-config/**`<br>`tooling/eslint-config/**`<br>`pnpm-lock.yaml`<br>`package.json`<br>`pnpm-workspace.yaml` |
| anyhunt-admin   | `apps/anyhunt/admin/www/Dockerfile` | 80   | `admin.anyhunt.app`           | Build Args：`VITE_API_URL`<br>`VITE_AUTH_URL`                                                                                                                                                      | `apps/anyhunt/admin/www/**`<br>`packages/types/**`<br>`packages/auth-client/**`<br>`packages/ui/**`<br>`tooling/typescript-config/**`<br>`tooling/eslint-config/**`<br>`pnpm-lock.yaml`<br>`package.json`<br>`pnpm-workspace.yaml`                                                   |
