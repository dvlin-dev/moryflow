...
[PROTOCOL]: 本文更新需同步 `docs/index.md`、`docs/CLAUDE.md`、`docs/architecture/CLAUDE.md`。
-->
...
3. 文档与约束闸门：
   - `docs/CLAUDE.md`、`docs/architecture/CLAUDE.md`、`docs/index.md` 同步回写到“model-bank 单一事实源”
...
8. Phase 7（done）
   ...
   - 文档闸门通过：
     - `docs/CLAUDE.md`、`docs/architecture/CLAUDE.md`、`docs/index.md`、根 `CLAUDE.md` 已回写。
...
2. 同步 `docs/index.md`、`docs/CLAUDE.md`、`docs/architecture/CLAUDE.md` 的阶段状态与结论。
