...
- Moryflow PC 对话流运行时重构方案（streamAgentRun，implemented）：`docs/architecture/moryflow-pc-chat-stream-runtime-refactor-plan.md`（2026-02-28：follow-up F1~F4 已完成；落地“canonical 协议单轨（text-delta/reasoning-delta/done）+ provider 差异上收 normalizer”，并补齐回归测试与日志指标）
