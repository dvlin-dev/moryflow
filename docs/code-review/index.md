...
| P1       | Anyhunt Server：Agent/LLM/Embedding          | 提示词/工具调用/流式协议/策略注入/成本控制   | `apps/anyhunt/server/src/agent/`, `apps/anyhunt/server/src/llm/`, `apps/anyhunt/server/src/embedding/`, `apps/anyhunt/server/src/console-playground/`                               | `docs/code-review/anyhunt-server-agent-llm.md`       | done (2026-01-26 fix; embedding keep)                                                           |
