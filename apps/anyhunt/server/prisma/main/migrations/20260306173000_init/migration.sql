...
-- CreateEnum
CREATE TYPE "ApiKeyCleanupTaskStatus" AS ENUM ('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED');
...
CREATE TABLE "ApiKey" (
    ...
    "keyPrefix" TEXT NOT NULL DEFAULT 'ah_',
...
-- CreateTable
CREATE TABLE "ApiKeyCleanupTask" (
    "id" TEXT NOT NULL,
    "apiKeyId" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "status" "ApiKeyCleanupTaskStatus" NOT NULL DEFAULT 'PENDING',
    ...
    CONSTRAINT "ApiKeyCleanupTask_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ApiKeyCleanupTask_apiKeyId_key" ON "ApiKeyCleanupTask"("apiKeyId");

-- CreateIndex
CREATE INDEX "ApiKeyCleanupTask_status_createdAt_idx" ON "ApiKeyCleanupTask"("status", "createdAt");

-- CreateIndex
CREATE INDEX "ApiKeyCleanupTask_userId_createdAt_idx" ON "ApiKeyCleanupTask"("userId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "ApiKeyCleanupTask" ADD CONSTRAINT "ApiKeyCleanupTask_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
