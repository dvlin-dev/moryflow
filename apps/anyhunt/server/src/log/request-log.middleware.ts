...
const ROUTE_GROUP_PREFIXES: Array<{ prefix: string; group: string }> = [
  ...
  { prefix: '/api/v1/retrieval', group: 'retrieval' },
  { prefix: '/api/v1/memories', group: 'memory' },
  { prefix: '/api/v1/memory-exports', group: 'memory-export' },
  { prefix: '/api/v1/sources', group: 'source' },
  { prefix: '/api/v1/source-revisions', group: 'source-revision' },
