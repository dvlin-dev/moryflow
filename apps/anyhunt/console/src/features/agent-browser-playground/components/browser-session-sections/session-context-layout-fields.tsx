/**
 * [PROPS]: SessionContextLayoutFieldsProps
 * [EMITS]: none
 * [POS]: Session 上下文布局字段片段（viewport/device/locale/color/geo）
 */
...
type SessionContextLayoutFieldsProps = {
  form: UseFormReturn<BrowserSessionValues>;
};

export function SessionContextLayoutFields({ form }: SessionContextLayoutFieldsProps) {
  return (
    <>
