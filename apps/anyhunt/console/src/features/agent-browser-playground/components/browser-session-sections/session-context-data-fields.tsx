/**
 * [PROPS]: SessionContextDataFieldsProps
 * [EMITS]: none
 * [POS]: Session 上下文数据字段片段（permissions/headers/http/video）
 */
...
type SessionContextDataFieldsProps = {
  form: UseFormReturn<BrowserSessionValues>;
};

export function SessionContextDataFields({ form }: SessionContextDataFieldsProps) {
  return (
    <>
      <FormField
