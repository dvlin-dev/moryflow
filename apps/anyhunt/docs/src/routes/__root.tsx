...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      {
        property: 'og:title',
        content: 'Anyhunt - Web Scraping API',
      },
      {
      ...
      {
        property: 'og:url',
        content: 'https://docs.anyhunt.app',
      },
      {
    ...
    links: [
      ...
      // Hreflang for i18n SEO
      {
        rel: 'alternate',
        hrefLang: 'en',
        href: 'https://docs.anyhunt.app/docs',
      },
      {
        rel: 'alternate',
        hrefLang: 'zh',
        href: 'https://docs.anyhunt.app/zh/docs',
      },
      {
        rel: 'alternate',
        hrefLang: 'x-default',
