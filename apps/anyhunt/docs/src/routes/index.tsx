...
export const Route = createFileRoute('/')({
  head: () => ({
    meta: [
      {
        title: 'Anyhunt - Web Screenshot API',
      },
      {
        name: 'description',
        content:
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <header className="border-b bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <span className="font-semibold text-xl">Anyhunt</span>
      ...
      <main className="container mx-auto px-4 py-24 text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
          Capture high-quality screenshots of any webpage with a simple REST API. Fast, reliable,
          and affordable.
        </p>
        ...
        <div className="mt-16 max-w-2xl mx-auto text-left">
          <div className="bg-card border overflow-hidden shadow-lg">
            ...
            <pre className="p-4 text-sm overflow-x-auto">
              <code className="text-green-600 dark:text-green-400">{`curl -X POST https://server.anyhunt.app/api/v1/screenshots \\
  ...
  -d '{"url": "https://example.com"}'`}</code>
      ...
      <footer className="border-t py-8 mt-24">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} Anyhunt. All rights reserved.
        </div>
      </footer>
    </div>
  );
