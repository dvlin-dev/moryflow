...
const codeExamples: Record<Language, string> = {
  curl: `# Store a memory
curl -X POST https://server.anyhunt.app/api/v1/memories \\
...
# Search memories
curl -X POST https://server.anyhunt.app/api/v1/memories/search \\
  -H "Authorization: Bearer ah_your_api_key" \\
  -d '{ "query": "user preferences", "limit": 5 }'`,
  typescript: `import { Memox } from '@anyhunt/memox-sdk';

const client = new Memox('YOUR_API_KEY');
    ...
    <section className="border-b border-border bg-muted/30 py-20 md:py-28">
      <Container>
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-muted-foreground">Store and search memories with a simple API.</p>
        </div>
