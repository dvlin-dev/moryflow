  ...
  renderer: {
    ...
    resolve: {
      alias: [
        ...
        { find: /^@aiget\/ui\/(.*)$/, replacement: resolve(__dirname, '../../../packages/ui/src/$1') },
        // styles 目录在包根目录，需单独处理
        { find: /^@aiget\/tiptap\/styles\/(.*)$/, replacement: resolve(__dirname, '../../../packages/tiptap/styles/$1') },
        { find: /^@aiget\/tiptap\/(.*)$/, replacement: resolve(__dirname, '../../../packages/tiptap/src/$1') },
