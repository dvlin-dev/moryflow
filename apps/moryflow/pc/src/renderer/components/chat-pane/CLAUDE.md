...
- 2026-02-03：移除 Header inset 注入，避免锚点下沉与抖动。
...
- 2026-02-02：ConversationSection 补齐 flex/min-h-0 约束，保证输入区固定与列表滚动。
- 2026-02-02：消息列表新增 loading 占位，发送后用户消息顶到顶部。
- 2026-02-02：loading 图标对齐到 AI 文案起始位置，保持消息观感。
