...
describe('automation runner', () => {
  it(
    'conversation-session source reads the latest 6 turns and appends run output back to source history',
    { timeout: 30_000 },
    async () => {
  ...
  it(
    'automation-context source reads its own recent context and still runs in isolated mode',
    { timeout: 30_000 },
    async () => {
