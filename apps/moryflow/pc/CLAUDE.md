...
- Release docs（2026-03-09）：PC 发布说明已收口到 `docs/design/moryflow/runbooks/pc-release-and-auto-update.md` 与 `macos-code-signing.md`；公开下载口径统一为 GitHub Releases 手动下载、`download.moryflow.com` 应用内更新、当前平台仅公开 macOS arm64/x64，Windows 暂不承诺。
