  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: 'description',
        content:
          "MoryFlow - Your AI note-taking companion that reads your notes, remembers what you've said, and helps you get things done.",
      },
      // Open Graph
      {
        property: 'og:title',
      ...
      },
      {
        ...
        content:
          "A note-taking app with a built-in AI assistant that reads your notes, remembers what you've said, and helps you get things done.",
      },
      {
        property: 'og:type',
        content: 'website',
