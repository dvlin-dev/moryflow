    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <main className="container mx-auto px-4 py-24 text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
          MoryFlow is a note-taking app with a built-in AI assistant called Mory. It reads your
          notes, remembers what you've said, and helps you get things done.
        </p>
        ...
        <div className="mt-24 grid md:grid-cols-3 gap-8 text-left">
          <div className="p-6 border bg-card rounded-lg">
            ...
            <p className="text-muted-foreground">
              Mory reads your notes and learns your habits and preferences. The more you chat, the
          ...
          <div className="p-6 border bg-card rounded-lg">
            ...
            <p className="text-muted-foreground">
              All your content is stored as regular files on your own computer. Nothing uploaded,
              nothing shared, works offline too.
            </p>
          </div>
          <div className="p-6 border bg-card rounded-lg">
            <h3 className="font-semibold text-lg mb-2">Actually Gets Things Done</h3>
            <p className="text-muted-foreground">
              Not just chat—helps you prep for exams, plan events, organize trips, and write work
              summaries.
            </p>
          </div>
          <div className="p-6 border bg-card rounded-lg">
            ...
            <p className="text-muted-foreground">
              Familiar editing experience with Markdown, code blocks, and tables. Just write what
              comes to mind.
            </p>
          </div>
          <div className="p-6 border bg-card rounded-lg">
            ...
            <p className="text-muted-foreground">
              Supports OpenAI, Claude, DeepSeek, and 20+ providers. Or run local models completely
              offline.
            </p>
          </div>
          <div className="p-6 border bg-card rounded-lg">
            ...
            <p className="text-muted-foreground">
              We're constantly improving and adding new features. Download free now and grow with
              us.
            </p>
          </div>
        </div>
