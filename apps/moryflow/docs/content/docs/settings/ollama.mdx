...
description: "Ollama lets you run AI models on your own computer—fully offline, fully private."
---
...
2. Find the Ollama area or related local-model entry
