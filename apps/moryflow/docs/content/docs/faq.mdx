...
### Where Is the Windows Download?

**Answer**: Windows is temporarily not published on the public download page.

Public builds currently ship for:

- macOS (Apple Silicon)
- macOS (Intel)

We will restore the Windows installer after the Windows release pipeline is brought back.

### macOS Says "Developer Cannot Be Verified"

**Problem**: In a rare case, macOS still blocks the app even though it was downloaded from the official release page.
...
**Answer**: MoryFlow checks automatically, but download and install stay manual.

Typical flow:

1. The app checks for updates
2. You click **Download update**
3. You click **Restart to update**

See [Download & Updates](/docs/getting-started/updates) for the full flow.
...
4. See [Multi-device Sync](/docs/advanced/sync) for more
