...
import type { VaultListParams, UserStorageListParams } from '@/types/storage';
 ...
 * 获取用户存储列表
 */
export function useUserStorageList(params: { page: number; pageSize?: number; search?: string }) {
