...
-- CreateEnum
CREATE TYPE "WorkspaceContentRevisionMode" AS ENUM ('INLINE_TEXT', 'SYNC_OBJECT_REF');

-- CreateEnum
CREATE TYPE "WorkspaceContentOutboxEventType" AS ENUM ('UPSERT', 'DELETE');
...
-- CreateTable
CREATE TABLE "WorkspaceDocumentRevision" (
    "id" TEXT NOT NULL,
    "documentId" TEXT NOT NULL,
    "contentHash" TEXT NOT NULL,
    ...
    "contentText" TEXT,
    "syncObjectKey" TEXT,
    "storageRevision" TEXT,
    "mode" "WorkspaceContentRevisionMode" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "WorkspaceDocumentRevision_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "WorkspaceContentOutbox" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT NOT NULL,
    "documentId" TEXT NOT NULL,
    "revisionId" TEXT,
    "eventType" "WorkspaceContentOutboxEventType" NOT NULL,
    ...
    CONSTRAINT "WorkspaceContentOutbox_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "PendingEmailSignup_completionTokenHash_key" ON "PendingEmailSignup"("completionTokenHash");
...
-- CreateIndex
CREATE UNIQUE INDEX "Workspace_userId_clientWorkspaceId_key" ON "Workspace"("userId", "clientWorkspaceId");

-- CreateIndex
CREATE UNIQUE INDEX "Vault_workspaceId_key" ON "Vault"("workspaceId");
...
-- CreateIndex
CREATE UNIQUE INDEX "SyncFile_documentId_key" ON "SyncFile"("documentId");
...
-- CreateIndex
CREATE UNIQUE INDEX "WorkspaceDocument_currentRevisionId_key" ON "WorkspaceDocument"("currentRevisionId");

-- CreateIndex
CREATE INDEX "WorkspaceDocument_workspaceId_updatedAt_idx" ON "WorkspaceDocument"("workspaceId", "updatedAt");

-- CreateIndex
CREATE UNIQUE INDEX "WorkspaceDocument_workspaceId_path_key" ON "WorkspaceDocument"("workspaceId", "path");

-- CreateIndex
CREATE INDEX "WorkspaceDocumentRevision_documentId_createdAt_idx" ON "WorkspaceDocumentRevision"("documentId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "WorkspaceDocumentRevision_documentId_contentHash_key" ON "WorkspaceDocumentRevision"("documentId", "contentHash");

-- CreateIndex
CREATE INDEX "WorkspaceContentOutbox_processedAt_deadLetteredAt_createdAt_idx" ON "WorkspaceContentOutbox"("processedAt", "deadLetteredAt", "createdAt");

-- CreateIndex
CREATE INDEX "WorkspaceContentOutbox_leasedBy_leaseExpiresAt_idx" ON "WorkspaceContentOutbox"("leasedBy", "leaseExpiresAt");

-- CreateIndex
CREATE INDEX "WorkspaceContentOutbox_workspaceId_documentId_createdAt_idx" ON "WorkspaceContentOutbox"("workspaceId", "documentId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "SyncFile" ADD CONSTRAINT "SyncFile_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "WorkspaceDocument"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WorkspaceDocument" ADD CONSTRAINT "WorkspaceDocument_currentRevisionId_fkey" FOREIGN KEY ("currentRevisionId") REFERENCES "WorkspaceDocumentRevision"("id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "WorkspaceDocumentRevision" ADD CONSTRAINT "WorkspaceDocumentRevision_documentId_fkey" FOREIGN KEY ("documentId") REFERENCES "WorkspaceDocument"("id") ON DELETE CASCADE ON UPDATE CASCADE;
