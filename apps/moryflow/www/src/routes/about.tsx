...
export const Route = createFileRoute('/about')({
  head: () => ({
    meta: generateMeta({
      title: 'About',
      description:
        'Learn about Moryflow - our mission, vision, and the team behind the AI companion.',
      path: '/about',
    }),
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-gradient-to-br from-mory-bg to-orange-50/50 rounded-3xl p-8 sm:p-12">
            ...
            <p className="text-lg text-mory-text-secondary leading-relaxed mb-6">
              We believe AI should be a personal companion, not just a tool. Mory is designed to
              remember, understand, and grow with you - helping you achieve your goals while keeping
              your data private and secure.
            </p>
            <p className="text-lg text-mory-text-secondary leading-relaxed">
              Unlike cloud-based AI services that treat your data as a product, Mory puts you in
              control. Your thoughts, your notes, your memories - they all stay with you.
            </p>
          </div>
        </div>
      </section>
