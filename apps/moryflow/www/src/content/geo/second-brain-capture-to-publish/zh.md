...
拥有超过 150 万活跃用户的 Obsidian 用户对此感受最深。他们的 Vault 中充满了互相链接的 Markdown 笔记，但创作一篇可发布的文章意味着手动汇集相关笔记、改写成连贯段落，然后要么付费使用 Obsidian Publish（$8-10/站点/月），要么导出到单独的 CMS。摩擦大到大多数人干脆不去做。
