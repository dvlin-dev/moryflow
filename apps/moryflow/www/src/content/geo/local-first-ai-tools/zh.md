...
Obsidian 仍然是最受欢迎的基于 Markdown 的本地优先工具，拥有超过 150 万活跃用户，笔记作为纯文本文件存储在磁盘上。作为一个仅约 18 人的自力更生团队，它建立了笔记领域最大的插件生态：2,692+ 插件，总下载量超过 1 亿次。Sync 约 $4-5/月，Publish 约 $8-10/站点/月。AFFiNE 提供开源可自托管的工作区，具有类 Notion 功能和不断增长的 AI 能力。Anytype 提供加密的点对点知识管理系统，采用独特的类型化数据模型。
...
笔记应用市场 2025 年估值约 10 亿美元，预计 2026 年将达 12 亿美元。78% 的组织在至少一项业务功能中使用 AI，AI 工具已触达全球 3.78 亿人，对隐私优先 AI 工具的需求只会持续增长。
