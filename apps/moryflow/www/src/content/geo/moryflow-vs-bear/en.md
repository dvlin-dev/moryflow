...
faqs:
  ...
  - question: 'Does Bear have any AI features?'
    answer: 'No. Bear focuses purely on writing and organization. There are no AI features — no chat, no agents, no AI-assisted editing.'
  - question: 'Does Bear work on Windows or Linux?'
    answer: 'No. Bear is exclusive to Apple platforms — macOS, iOS, and iPadOS. Moryflow is a macOS desktop app with plans for broader platform support.'
  - question: 'Which tool is better for quick notes?'
    answer: 'Bear is exceptionally fast for quick capture with its tag-based organization and clean editor. Moryflow is equally capable for capture but adds AI-powered organization and research on top.'
  - question: 'Is Bear open source?'
    answer: 'No. Bear is closed source and developed by Shiny Frog. Moryflow is open source under the MIT license.'
ctaTitle: 'Add AI Agents to Your Notes'
ctaDescription: 'Download Moryflow free — the Markdown experience you love, plus autonomous AI agents and one-click publishing.'
relatedPages:
