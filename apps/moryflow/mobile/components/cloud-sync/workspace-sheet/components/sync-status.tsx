/**
 * [PROPS]: isSyncing, statusInfo, lastSyncText, colors, hint
 * [EMITS]: none
...
export function SyncStatus({ isSyncing, statusInfo, lastSyncText, colors, hint }: SyncStatusProps) {
  ...
  return (
    <View
      ...
      <View style={{ flex: 1 }}>
        ...
        {hint ? (
          <Text style={{ marginTop: 4, fontSize: 12, color: colors.textTertiary }}>{hint}</Text>
        ) : null}
      </View>
    </View>
  );
