/**
 * [INPUT]: apiKeyId, CreateRelationInput, relation queries
 ...
 *
 * [PROTOCOL]: When modifying this file, you MUST update this header and src/relation/CLAUDE.md
 */
...
import type { CreateRelationInput } from './dto';
...
export class RelationService {
   ...
   * 创建关系
   */
  async create(apiKeyId: string, dto: CreateRelationInput): Promise<Relation> {
