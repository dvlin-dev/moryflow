...
Marketing landing page for the Memox platform. TanStack Start application with interactive demo and pricing information.
...
├── depends on → @aiget/ui (shared components)
└── peers with → apps/docs (links to docs)
```

---

_See root [CLAUDE.md](../../CLAUDE.md) for global conventions_
