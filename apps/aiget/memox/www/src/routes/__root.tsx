...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { title: 'memox - Semantic Memory API for AI Agents' },
      {
        name: 'description',
        content:
          'Give your AI agents long-term memory. Semantic search, knowledge graphs, and entity extraction API.',
      },
      { property: 'og:title', content: 'memox - Semantic Memory API for AI' },
      {
        property: 'og:description',
        content:
          'Give your AI agents long-term memory. Semantic search, knowledge graphs, and entity extraction API.',
      },
      { property: 'og:image', content: 'https://memox.dev/og-image.png' },
      { property: 'og:url', content: 'https://memox.dev' },
