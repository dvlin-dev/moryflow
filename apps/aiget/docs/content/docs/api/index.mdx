---
title: API Reference
description: Complete API documentation for AIGet Web Scraper
---

# API Reference

AIGet provides a comprehensive REST API for web scraping and content extraction. All endpoints use JSON for requests and responses.
...
Get your API key from the [Console](https://console.aiget.dev/api-keys).
