...
AIGet uses rate limits to ensure fair usage and service reliability. Understanding these limits helps you build robust integrations.
...
View your current quota usage in the [AIGet Console](https://console.aiget.dev). The dashboard shows:
