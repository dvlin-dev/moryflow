---
title: FAQ
description: Frequently asked questions about AIGet
---
...
AIGet is a web scraping API that extracts content from any webpage. You send a URL via our API, and we return clean, structured content in your preferred format (Markdown, HTML, links, or screenshots).
...
We target 99.9% uptime. Check our status page at status.aiget.dev for real-time availability.
...
Still have questions? Contact us at support@aiget.dev.
