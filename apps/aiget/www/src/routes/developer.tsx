...
import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Icon } from '@aiget/ui';
import {
  ArrowLeft02Icon,
  ApiIcon,
  Book02Icon,
...
export const Route = createFileRoute('/developer')({
  ...
  head: () => ({
    meta: [
      { title: 'Developer - Aiget Dev' },
      {
        name: 'description',
        content:
          'Aiget Dev API documentation and developer resources. Build with Fetchx and Memox APIs.',
      },
    ],
  }),
});
