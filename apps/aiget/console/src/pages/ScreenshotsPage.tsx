...
import { ArrowUpRight01Icon, Image01Icon, RefreshIcon } from '@hugeicons/core-free-icons';
import {
  Badge,
  Button,
  Card,
      ...
      {isLoading ? (
        ...
        <Card>
          <Empty className="py-12">
            <Icon icon={Image01Icon} className="mb-4 h-12 w-12 text-muted-foreground" />
              ...
              return (
                ...
                >
                  ...
                  <div className="relative aspect-video bg-muted">
                    ...
                    {/* 状态标签 */}
                    <Badge variant={statusConfig.variant} className="absolute right-2 top-2">
                      {statusConfig.label}
                    </Badge>
                    {/* 缓存标识 */}
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex items-center justify-between text-xs text-muted-foreground">
                      ...
                      {screenshot.processingMs && <span>{screenshot.processingMs}ms</span>}
                    </div>
                  </CardContent>
                </Card>
              );
