      ...
      <Container className="relative">
        <div className="flex flex-col items-center py-24 text-center md:py-32 lg:py-40">
          ...
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
            Semantic memory infrastructure for AI applications. Store, search, and retrieve memories
            with vector embeddings and knowledge graphs.
          </p>

          {/* CTA Buttons */}
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <a href="https://console.memox.dev/signup">
              <Button size="lg" className="font-mono">
                Get Started Free
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </a>
            <a href="https://docs.memox.dev">
