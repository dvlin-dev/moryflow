...
const codeExamples: Record<Language, string> = {
  curl: `# Store a memory
curl -X POST https://memox.aiget.dev/v1/memories \\
...
# Search memories
curl -X POST https://memox.aiget.dev/v1/memories/search \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
      ...
      <Container>
        ...
        <div className="mx-auto max-w-3xl overflow-hidden border border-border bg-background">
          ...
          <div className="flex border-b border-border">
            ...
            <a
              href="https://github.com/dvlin-dev/Aiget/issues/new?title=SDK%20Request%3A%20%5BLanguage%5D"
              target="_blank"
