...
Core memory service for the Memox platform. Handles memory CRUD operations, semantic search, embedding generation, and entity/relation extraction.
...
_See [apps/server/CLAUDE.md](../CLAUDE.md) for server conventions_
