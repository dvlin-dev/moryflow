...
import { CreateMemoryDto, SearchMemoryDto, ListMemoryQueryDto } from './dto';
...
export class MemoryController {
  ...
  async create(@ApiKeyId() apiKeyId: string, @Body() dto: CreateMemoryDto) {
  ...
  async search(@ApiKeyId() apiKeyId: string, @Body() dto: SearchMemoryDto) {
  ...
  async list(@ApiKeyId() apiKeyId: string, @Query() query: ListMemoryQueryDto) {
  ...
  async getById(@ApiKeyId() apiKeyId: string, @Param('id') id: string) {
  ...
  @ApiParam({ name: 'id', description: 'Memory ID' })
  async delete(@ApiKeyId() apiKeyId: string, @Param('id') id: string) {
