# `@moryflow/agents-sandbox` API 参考

## 模块导入

```ts
import * as ModuleApi from '@moryflow/agents-sandbox';
```
...
| 导出                                                                                | 说明     |
| ----------------------------------------------------------------------------------- | -------- |
| `export { SandboxManager } from './sandbox-manager';`                               | 核心导出 |
| `export type {`                                                                     | 核心导出 |
| `export {`                                                                          | 核心导出 |
| `export { detectPlatform, getPlatformName } from './platform';`                     | 核心导出 |
| `export {`                                                                          | 核心导出 |
| `export { PathAuthorization } from './authorization';`                              | 核心导出 |
| `export { isPathEqualOrWithin, normalizeAuthorizedPath } from './path-utils';`      | 核心导出 |
| `export { createSandboxBashTool, type SandboxBashToolOptions } from './bash-tool';` | 核心导出 |
...
- [模块深度文档](../AI系统/Agent核心/agents-sandbox.md)
- [Wiki 首页](../index.md)
