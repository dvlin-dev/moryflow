# `@moryflow/embed` API 参考

## 模块导入

```ts
import * as ModuleApi from '@moryflow/embed';
```
...
| 导出                                                              | 说明     |
| ----------------------------------------------------------------- | -------- |
| `export { createEmbedClient, type EmbedClient } from './client';` | 核心导出 |
| `export type {`                                                   | 核心导出 |
| `export { EmbedError, NetworkError, ApiError } from './errors';`  | 核心导出 |
| `export { detectProvider, isSupported } from './utils';`          | 核心导出 |
